...
void KoSpecificIsolation::setVetoesParam( const edm::ParameterSet& pset ){
...
void KoSpecificIsolation::createAbsVetoes(){
...
std::ostream& operator<<(std::ostream& out, const KoSpecificIsolation& isoDepParam){
