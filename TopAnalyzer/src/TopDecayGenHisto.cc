...
private:
  ...
  TH1F* hMtt_LPJ;
  TH1F* hMtt_LPJ_Pton;
  TH1F* hMtt_LPJ_Pton_Statu2;
  TH1F* hMtt_DIL;
  TH1F* hMtt_DIL_Pton;
  TH1F* hMtt_DIL_Pton_Statu2;

  TH2F* hMtt_bquarkPt;
  TH2F* hMtt_bquarkStatu2Pt;
  TH2F* hMtt_leptonPt;
  TH2F* hMtt_bquarkEta;
  TH2F* hMtt_leptonEta;
...
TopDecayGenHisto::TopDecayGenHisto(const edm::ParameterSet& pset)
{
  ...
  hMtt_LPJ_Pton_Statu2 = fs->make<TH1F>( "hMtt_LPJ_Pton_Statu2"  , "M_{tt}", 2500,  0., 2500. );
  hMtt_DIL = fs->make<TH1F>( "hMtt_DIL"  , "M_{tt}", 2500,  0., 2500. );
  hMtt_DIL_Pton = fs->make<TH1F>( "hMtt_DIL_Pton"  , "M_{tt}", 2500,  0., 2500. );
  hMtt_DIL_Pton_Statu2 = fs->make<TH1F>( "hMtt_DIL_Pton_Statu2"  , "M_{tt}", 2500,  0., 2500. );
  hMtt_bquarkPt = fs->make<TH2F>( "hMtt_bquarkPt", "M_{tt} vs bquarkPt", 500, 0, 500, 2500, 0, 2500);
  hMtt_bquarkStatu2Pt = fs->make<TH2F>( "hMtt_bquarkStatu2Pt", "M_{tt} vs bquarkPt", 500, 0, 500, 2500, 0, 2500);
...
bool TopDecayGenHisto::filter(edm::Event& iEvent, const edm::EventSetup& eventSetup)
{
  ...
  std::vector<double> bquarkStatu2Pt(2,static_cast<double>(-1));
  std::vector<double> leptonEta(2,static_cast<double>(-1));
  std::vector<double> bquarkEta(2,static_cast<double>(-1));
  std::vector<double> bquarkStatu2Eta(2,static_cast<double>(-1));
         ...
         for ( unsigned ibDaughter=0; ibDaughter<nbDaughters; ++ibDaughter ) {
           ...
           if( decayId == 5 ){
             assert( decayStatus == 2);
              bquarkStatu2Pt[ntop] = decay->pt();
              bquarkStatu2Eta[ntop] = fabs( decay->eta() );
           }
         }
      }
  ...
  bool visibleDILStatu2 = leptonPt[0] > 20 && leptonPt[1] > 20 && leptonEta[0] < 2.4 && leptonEta[1] < 2.4 && bquarkStatu2Pt[0] > 30 && bquarkStatu2Pt[1] > 30 && bquarkStatu2Eta[1] < 2.4 && bquarkStatu2Eta[2] < 2.4;
  bool visibleLPJStatu2 = ( ( leptonPt[0] > 30 && leptonEta[0] < 2.1 && leptonPt[1] < 0 ) || ( leptonPt[0] < 0 && leptonPt[1] > 30 && leptonEta[1] < 2.1 ) ) && bquarkStatu2Pt[0] > 30 && bquarkStatu2Pt[1] > 30 && bquarkStatu2Eta[0] < 2.4 && bquarkStatu2Eta[1] < 2.4;
  ...
  if( visibleLPJStatu2 ) hMtt_LPJ_Pton_Statu2->Fill(Mtt);
  if( visibleDILStatu2 ) hMtt_DIL_Pton_Statu2->Fill(Mtt);
  ...
  if(bquarkStatu2Pt[0] > 0) hMtt_bquarkStatu2Pt->Fill( bquarkStatu2Pt[0], Mtt);
  if(bquarkStatu2Pt[1] > 0) hMtt_bquarkStatu2Pt->Fill( bquarkStatu2Pt[1], Mtt);
