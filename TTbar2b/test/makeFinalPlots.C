...
const int nBkg = 5;
const char* bkgNames[] = {"hMC_TTbarcc","hMC_TTbarll","hMC_TTbarOthers","hMC_SingleTop", "hMC_DYll"};
const char* bkgLabels[] = {
  "t#bar{t}+cc", "t#bar{t}+ll","t#bar{t} others","Single top", "Z/#gamma* #rightarrow ll"
};
...
void makeFinalPlots(TString noteNumber = "TTBB_26Mar_CSVT/v1")
{
  setTDRStyle();
...
//  cutStepPlots("Step_6", "nbJet_CSVT", "b-Jet multiplicity(CSVT)", 1, 1e6, true);
  ...
  cutStepPlots("Step_4", "nbJet30_CSVT", "Jet multiplicity", 0.1, 5000, true);
  cutStepPlots("Step_5", "addjet1_bDisCSV", "b-Discriminator (CSV)", 0.1, 5000, true);
  cutStepPlots("Step_5", "addjet2_bDisCSV", "b-Discriminator (CSV)", 0.1, 5000, true);
...
//  cutStepPlots("Step_6", "nbJet_CSVT", "b-Jet multiplicity(CSVT)", 0, 3000, false);
  ...
  printCutFlow(path,"MuMu", "nbJet30_CSVT,nbJet30_CSVT,nbJet30_CSVT,nbJet30_CSVT,nbJet30_CSVT");
  printCutFlow(path,"ElEl", "nbJet30_CSVT,nbJet30_CSVT,nbJet30_CSVT,nbJet30_CSVT,nbJet30_CSVT" );
  printCutFlow(path,"MuEl", "nbJet30_CSVT,nbJet30_CSVT,nbJet30_CSVT,nbJet30_CSVT,nbJet30_CSVT");
