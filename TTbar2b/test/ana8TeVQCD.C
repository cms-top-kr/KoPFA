...
void ana8TeVQCD()
{
  ...
  ana("MuMu", "TOPTTBB_8TeV_QCD_iso_2j1b_fixiso_15/MuMu","lep1_relIso03 < 0.15 && lep2_relIso03 < 0.15 && abs(ZMass-91) > 15");
  ana("ElEl", "TOPTTBB_8TeV_QCD_iso_2j1b_fixiso_15/ElEl","lep1_relIso03 < 0.15 && lep2_relIso03 < 0.15 && abs(ZMass-91) > 15");
  ana("MuEl", "TOPTTBB_8TeV_QCD_iso_2j1b_fixiso_15/MuEl","lep1_relIso03 < 0.15 && lep2_relIso03 < 0.15");

  ana("MuMu", "TOPTTBB_8TeV_QCD_noiso_2j1b_fixiso_15/MuMu","lep1_relIso03 > 0.15 && lep2_relIso03 > 0.15 && abs(ZMass-91) > 15");
  ana("ElEl", "TOPTTBB_8TeV_QCD_noiso_2j1b_fixiso_15/ElEl","lep1_relIso03 > 0.15 && lep2_relIso03 > 0.15 && abs(ZMass-91) > 15");
  ana("MuEl", "TOPTTBB_8TeV_QCD_noiso_2j1b_fixiso_15/MuEl","lep1_relIso03 > 0.15 && lep2_relIso03 > 0.15");

  ana("MuMu", "TOPTTBB_8TeV_QCD_2j1b_fixiso_15/MuMu","abs(ZMass-91) > 15");
  ana("ElEl", "TOPTTBB_8TeV_QCD_2j1b_fixiso_15/ElEl","abs(ZMass-91) > 15");
  ana("MuEl", "TOPTTBB_8TeV_QCD_2j1b_fixiso_15/MuEl","");
...
void ana(string decayMode, string imageOutDir = "test", TCut isoCut)
{
  ...
  const std::string mcPath = "/afs/cern.ch/work/t/tjkim/public/store/ttbb/paper/V5_10_0/V0_0_8/";
  const std::string rdPath = "/afs/cern.ch/work/t/tjkim/public/store/ttbb/paper/V5_10_0/V0_0_8/";
...
//  TCut dilepton = "ttbarGen_dileptonic == 1";
  ...
  analyzer->addMCSig("TTbar", "t#bar{t}", mcPath+"/vallot_TTbarTuneZ2.root", 225, kRed+2, true);
