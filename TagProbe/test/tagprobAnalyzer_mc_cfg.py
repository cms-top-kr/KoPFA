...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    # IO parameters:
    InputFileNames = cms.vstring("result6/tagprob_mc.root"),
    InputDirectoryName = cms.string("tnpTree"),
    InputTreeName = cms.string("fitter_tree"),
    OutputFileName = cms.string("Efficiency_ID_mc.root"),
...
process.TagProbeFitTreeAnalyzerIso = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    InputTreeName = cms.string("fitter_tree"),
    OutputFileName = cms.string("Efficiency_Iso_mc.root"),
    NumCPU = cms.uint32(1),
    SaveWorkspace = cms.bool(True),
    floatShapeParameters = cms.bool(True),
#    fixVars = cms.vstring("mean"),
    ...
    Variables = cms.PSet(
        mass = cms.vstring("Tag-Probe Mass", "70", "110.0", "GeV/c^{2}"),
        pt = cms.vstring("Probe p_{T}", "0", "1000", "GeV/c"),
        abseta = cms.vstring("Probe #eta", "0", "2.5", "")
    ),
