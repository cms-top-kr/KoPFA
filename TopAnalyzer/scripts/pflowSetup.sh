...
addpkg CommonTools/CandAlgos

#ID on AOD
#cvs co -rV00-03-14-02 RecoEgamma/ElectronIdentification

## PF tags
cvs co -r maxime_20101126 -d AnalysisDataFormats/PFAnalyses UserCode/PFAnalyses/AnalysisDataFormats/PFAnalyses
cvs co -d PFAnalyses/CommonTools UserCode/PFAnalyses/CommonTools
...
cvs co -r TJ_Mar28 -d KoPFA UserCode/KoPFA
cvs co -r TJ_Mar31 -d KoPFA/TopAnalyzer UserCode/KoPFA/TopAnalyzer
