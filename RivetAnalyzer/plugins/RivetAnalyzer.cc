...
void RivetAnalyzer::beginJob(){
  ...
  rivetref = "RIVET_REF_PATH=" + string(cmsswbase) + "/src/KoPFA/RivetAnalyzer/data:" + string(cmsswrelease) + "/src/KoPFA/RivetAnalyzer/data";
  rivetinfo = "RIVET_INFO_PATH=" + string(cmsswbase) + "/src/KoPFA/RivetAnalyzer/data:" + string(cmsswrelease) + "/src/KoPFA/RivetAnalyzer/data";
