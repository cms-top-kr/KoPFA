void syn(){
  ...
  TFile * f_mm = new TFile("/afs/cern.ch/work/t/tjkim/public/store/top/paper/v2/vallot_Run2012MuMu.root");
  TFile * f_ee = new TFile("/afs/cern.ch/work/t/tjkim/public/store/top/paper/v2/vallot_Run2012ElEl.root");
  TFile * f_em = new TFile("/afs/cern.ch/work/t/tjkim/public/store/top/paper/v2/vallot_Run2012MuEl.root");
  ...
  cout << "step0a" << endl;
  cout << "MuMu = " << (int) h_mm->GetBinContent(1) << endl;
  cout << "ElEl = " << (int) h_ee->GetBinContent(1) << endl;
  cout << "MuEl = " << (int) h_em->GetBinContent(1) << endl;

  cout << "step0b" << endl;
  cout << "MuMu = " << (int) h_mm->GetBinContent(3) << endl;
  cout << "ElEl = " << (int) h_ee->GetBinContent(3) << endl;
  cout << "MuEl = " << (int) h_em->GetBinContent(3) << endl;

  cout << "step0c" << endl;
  cout << "MuMu = " << (int) h_mm->GetBinContent(4) << endl;
  cout << "ElEl = " << (int) h_ee->GetBinContent(4) << endl;
  cout << "MuEl = " << (int) h_em->GetBinContent(4) << endl;
