...
ElEl = cms.EDFilter('TopElElAnalyzer',
    ...
    puWeightLabel = cms.untracked.InputTag('PUweight','weight'),
    puUpWeightLabel = cms.untracked.InputTag('PUweight','weightplus'),
    puDwWeightLabel = cms.untracked.InputTag('PUweight','weightminus'),
    puNVertexLabel = cms.untracked.InputTag('PUweight','npileup'),
