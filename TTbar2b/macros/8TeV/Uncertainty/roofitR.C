void roofitR(){
  ...
  bool combine = true;
  int nbinsch = 20; //number of bins for each histograms. for example, b-jets multiplicity = 5 , b-dscriminatorCSV = 20, b-discriminatorCSV = 50
  ...
  TString fdd="METUp";//"puweightminus";
  TString fd="CSVT_"+fdd;
  TString path = "/afs/cern.ch/work/y/youngjo/public/For8Tev/v20130406_V00-00-08fixed/ANA/uncertainty/TTBB_"+fd;
  //TString path = "./TTBB_"+fd+"/";

//"/afs/cern.ch/work/t/tjkim/public/store/ttbb/paper/8TeV/histos/TTBB_CSVT";
...
*/
  ...
  if(nobj==2)c_fit_combined->Divide(2,1);    
  ...
  for(int j = 0 ; j < nobj; j++){
    ...
    hist_combined_data->GetXaxis()->SetTitle("b-Jet Multiplicity (CSVT)");
    hist_combined_data->GetYaxis()->SetTitle("Events");
    if(nobj==1)
    {
      hist_combined_ttbb->GetXaxis()->SetLabelFont(70);
      //hist_combined_ttbb->GetXaxis()->SetLabelOffset(0.01);
      hist_combined_ttbb->GetXaxis()->SetBinLabel(1,"0"); 
      hist_combined_ttbb->GetXaxis()->SetBinLabel(2,"1"); 
      hist_combined_ttbb->GetXaxis()->SetBinLabel(3,"2"); 
      hist_combined_ttbb->GetXaxis()->SetBinLabel(4,"3"); 
      hist_combined_ttbb->GetXaxis()->SetBinLabel(5,"4");
      hist_combined_ttbb->GetXaxis()->SetLabelSize(0.085);
    }
    ...
    MC->GetXaxis()->SetTitle("b-Jet Multiplicity (CSVT)"); 
  ...
  c_fit_combined->Print("c_final_fit_combined"+fd+".eps");
