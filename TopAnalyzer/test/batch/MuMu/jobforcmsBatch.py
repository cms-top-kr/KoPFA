...
datalist = ["Run2011A_official","Run2011A_MuonPhysics"]
...
#mcdir = currdir+"/test"
#datadir = mcdir
mcdir = "/castor/cern.ch/user/b/bhlee/ntuple/top/"+type+"/MC/Spring11_Mar29PromptReco"
datadir = "/castor/cern.ch/user/b/bhlee/ntuple/top/"+type+"/RD/Mar29PromptReco"
