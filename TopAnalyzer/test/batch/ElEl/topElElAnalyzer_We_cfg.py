...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('vallot_We.root')
)

process.load("PFAnalyses.TTbarDIL.Sources.ELE.MC.Fall10.patTuple_We_cff")
process.source.fileNames = [
#    'file:/data/export/jhgoh/TopAnalysis/pf2pat/ElEl/MC/20110425/We.root',
    'rfio:/castor/cern.ch/user/j/jhgoh/TopAnalysis/pf2pat/ElEl/MC/20110425/We.root',
]
