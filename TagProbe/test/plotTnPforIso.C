...
void plotTnPforIso(){
  ...
  TFile * f_Iso = new TFile("result_MUiso_pfmuon/plot_overall/Efficiency_Iso.root");
  //TFile * f_Iso_MC = new TFile("result/plot/Efficiency_Iso.root");
  TFile * f_Iso_MC = new TFile("result_MUiso_pfmuon/plot_overall/Efficiency_Iso_mcPU.root");
  ...
  if( datavsmc ){
    ...
    //dir_pt.push_back("tnpTreeIso/isIso06_ptoverall/fit_eff_plots");
    //dir_pt.push_back("tnpTreeIso/isIso07_ptoverall/fit_eff_plots");
    //dir_pt.push_back("tnpTreeIso/isIso08_ptoverall/fit_eff_plots");
    //dir_pt.push_back("tnpTreeIso/isIso09_ptoverall/fit_eff_plots");
    //dir_pt.push_back("tnpTreeIso/isIso10_ptoverall/fit_eff_plots");
    //dir_pt.push_back("tnpTreeIso/isIso11_pt/fit_eff_plots");
    dir_pt.push_back("tnpTreeIso/isIso12_pt/fit_eff_plots");
    //dir_pt.push_back("tnpTreeIso/isIso13_ptoverall/fit_eff_plots");
    //dir_pt.push_back("tnpTreeIso/isIso14_ptoverall/fit_eff_plots");
    //dir_pt.push_back("tnpTreeIso/isIso15_ptoverall/fit_eff_plots");
    dir_pt.push_back("tnpTreeIso/isIso16_pt/fit_eff_plots");
    //dir_pt.push_back("tnpTreeIso/isIso17_ptoverall/fit_eff_plots");
    //dir_pt.push_back("tnpTreeIso/isIso18_ptoverall/fit_eff_plots");
    //dir_pt.push_back("tnpTreeIso/isIso19_ptoverall/fit_eff_plots");
    dir_pt.push_back("tnpTreeIso/isIso20_pt/fit_eff_plots");
    //dir_pt.push_back("tnpTreeIso/isIso21_pt/fit_eff_plots");
    //dir_pt.push_back("tnpTreeIso/isIso22_ptoverall/fit_eff_plots");
    //dir_pt.push_back("tnpTreeIso/isIso23_ptoverall/fit_eff_plots");
    //dir_pt.push_back("tnpTreeIso/isIso24_ptoverall/fit_eff_plots");
    //dir_pt.push_back("tnpTreeIso/isIso25_ptoverall/fit_eff_plots");
    //dir_pt.push_back("tnpTreeIso/isIso26_ptoverall/fit_eff_plots");
    //dir_pt.push_back("tnpTreeIso/isIso27_ptoverall/fit_eff_plots");
    //dir_pt.push_back("tnpTreeIso/isIso28_ptoverall/fit_eff_plots");
    ...
    bool print = true; 
    //plotNewEff(f_Iso,f_Iso_MC,l1,l2,dir_abseta,plot_abseta, "abseta","isIso", lname, print);
