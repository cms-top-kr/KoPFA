...
#Data
process.load("KoPFA.CommonTools.Sources.CMG.V5_12_0_44X.Run2011.cmgTuple_MuMu_Run2011A16Jan2012v1_cff")
#MC
...
process.MuMu.run2012 = cms.untracked.bool( False) 
...
process.MuEl.run2012 = cms.untracked.bool( False)
...
process.ElEl.run2012 = cms.untracked.bool( False)
