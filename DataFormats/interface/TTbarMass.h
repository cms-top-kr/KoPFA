...
namespace Ko{
  ...
  private:
    ...
    void SetUser1M( const reco::Candidate::LorentzVector& bq1, const reco::Candidate::LorentzVector& bq2, const reco::Candidate::LorentzVector& lq1, const reco::Candidate::LorentzVector& lq2, const reco::Candidate::LorentzVector& le, const reco::Candidate::LorentzVector& met);
    void SetUser2M( const reco::Candidate::LorentzVector& bq1, const reco::Candidate::LorentzVector& bq2, const reco::Candidate::LorentzVector& lq1, const reco::Candidate::LorentzVector& lq2, const reco::Candidate::LorentzVector& le, const reco::Candidate::LorentzVector& met);
