void addTopVariables(TopAnalyzerLite* analyzer){
  ...
  analyzer->addMonitorPlot("Iso03lep1","lep1.relIso03()","relIso03lep1;relIso;Events", 40, 0, 0.4, 0.1, 20000);
  analyzer->addMonitorPlot("Iso03lep2","lep2.relIso03()","relIso03lep2;relIso;Events", 40, 0, 0.4, 0.1, 20000);
  ...
  analyzer->addMonitorPlot("secM1", "jets[ttbarKin.jid(0)].secvtxMass()", "Secondary Vertex Mass;Secondary Vertex Mass (GeV/c^{2});Events", 11, -0.49, 5.01, 0.1, 10,true);
  analyzer->addMonitorPlot("secM2", "jets[ttbarKin.jid(1)].secvtxMass()", "Secondary Vertex Mass;Secondary Vertex Mass (GeV/c^{2});Events", 11, -0.49, 5.01, 0.1, 10,true);
