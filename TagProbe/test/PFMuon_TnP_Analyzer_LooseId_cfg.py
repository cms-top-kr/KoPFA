...
process.tnpFit = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    #InputFileNames = cms.vstring("rfio:/castor/cern.ch/user/j/jkim/TopAna/TnpTree/Fall11/DYJetsToLL_IsoMu24_relIsoTag/tagprob_MC_loosemu_relIsoTag_12files.root"),
    InputFileNames = cms.vstring("rfio:/castor/cern.ch/user/j/jkim/TopAna/TnpTree/Fall11/DYJetsToLL_IsoMu24_relIsoTag_wmass/tagprob_MC_loosemu_relIsoTag_12files.root"),
    #InputDirectoryName = cms.string("tnpId"),
    InputDirectoryName = cms.string("tnpTree"),
    InputTreeName = cms.string("fitter_tree"),
    OutputFileName = cms.string("result_Id_loosemu_all_%s.root" % mode),
    NumCPU = cms.uint32(1),
