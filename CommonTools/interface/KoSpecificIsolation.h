#ifndef __KoPFA_CommonTools_interface_KoSpecificIsolation__
#define __KoPFA_CommonTools_interface_KoSpecificIsolation__
...
class KoSpecificIsolation {
 ...
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const KoSpecificIsolation& isoDepParam);
