...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('tagprob_data_loosemu.root')
)
...
process.GlobalTag.globaltag = cms.string('GR_R_53_V14::All')
...
triggerObjectSelection_Run2011AB   = 'type("TriggerMuon") && ( path("HLT_IsoMu24_v*"))'
...
process.patMuonTriggerMatch.matchedCuts = cms.string(triggerObjectSelection_Run2012AB)
...
process.p = cms.Path(
                     #process.taggedLooseMuons*process.triggerMatch*process.tagMuons
                     process.Muons +
