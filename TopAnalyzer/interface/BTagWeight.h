  ...
  public:
    ...
    double sfl(double pt, double eta)
    {
      ...
      if( algo_ == CSVL ){
        if( pt <= 670 ){
          if( fabs(eta) < 0.5) {
            if( sys_ == DWLight )  sf = ((0.994425+(-8.66392e-05*pt))+(-3.03813e-08*(pt*pt)))+(-3.52151e-10*(pt*(pt*pt)));
            else if( sys_ == UPLight )  sf = ((1.15628+(0.000437668*pt))+(-1.69625e-06*(pt*pt)))+(1.00718e-09*(pt*(pt*pt)));
            else sf = ((1.07536+(0.000175506*pt))+(-8.63317e-07*(pt*pt)))+(3.27516e-10*(pt*(pt*pt)));
          } else if( fabs(eta) >= 0.5 && fabs(eta) < 1.0) {
            if( sys_ == DWLight )  sf = ((0.998088+(6.94916e-05*pt))+(-4.82731e-07*(pt*pt)))+(1.63506e-10*(pt*(pt*pt)));
            else if( sys_ == UPLight )  sf = ((1.15882+(0.000579711*pt))+(-2.12243e-06*(pt*pt)))+(1.53771e-09*(pt*(pt*pt)));
            else sf = ((1.07846+(0.00032458*pt))+(-1.30258e-06*(pt*pt)))+(8.50608e-10*(pt*(pt*pt)));
          } else if( fabs(eta) >= 1.0 && fabs(eta) < 1.5) {
            if( sys_ == DWLight )  sf = ((1.00294+(0.000289844*pt))+(-7.9845e-07*(pt*pt)))+(5.38525e-10*(pt*(pt*pt)));
            else if( sys_ == UPLight )  sf = ((1.16292+(0.000659848*pt))+(-2.07868e-06*(pt*pt)))+(1.72763e-09*(pt*(pt*pt)));
            else sf = ((1.08294+(0.000474818*pt))+(-1.43857e-06*(pt*pt)))+(1.13308e-09*(pt*(pt*pt)));
          } else if( fabs(eta) >= 1.5 && fabs(eta) < 2.4) {
            if( sys_ == DWLight )  sf = ((0.979816+(0.000138797*pt))+(-3.14503e-07*(pt*pt)))+(2.38124e-10*(pt*(pt*pt)));
            else if( sys_ == UPLight )  sf = ((1.14357+(0.00020854*pt))+(-7.43519e-07*(pt*pt)))+(8.73742e-10*(pt*(pt*pt)));
            else sf = ((1.0617+(0.000173654*pt))+(-5.29009e-07*(pt*pt)))+(5.55931e-10*(pt*(pt*pt)));
          } else {
            if( sys_ == DWLight )  sf = ((0.979816+(0.000138797*pt))+(-3.14503e-07*(pt*pt)))+(2.38124e-10*(pt*(pt*pt)));
            else if( sys_ == UPLight )  sf = ((1.14357+(0.00020854*pt))+(-7.43519e-07*(pt*pt)))+(8.73742e-10*(pt*(pt*pt)));
            else sf = ((1.0617+(0.000173654*pt))+(-5.29009e-07*(pt*pt)))+(5.55931e-10*(pt*(pt*pt)));
          ...
          if( sys_ == DWLight )  sf = ((0.956023+(0.000825106*670.0))+(-3.18828e-06*(670.0*670.0)))+(2.81787e-09*(670.0*(670.0*670.0)));
          else if( sys_ == UPLight )  sf = ((1.11272+(0.00110104*670.0))+(-4.11956e-06*(670.0*670.0)))+(3.65263e-09*(670.0*(670.0*670.0)));
          else sf = ((1.0344+(0.000962994*670.0))+(-3.65392e-06*(670.0*670.0)))+(3.23525e-09*(670.0*(670.0*670.0)));
        }
      } else if( algo_ == CSVM ){
        if( pt <= 670){
          if( fabs(eta) < 0.8 ) {
            if( sys_ == DWLight )  sf = ((0.972455+(7.51396e-06*pt))+(4.91857e-07*(pt*pt)))+(-1.47661e-09*(pt*(pt*pt)));
            else if( sys_ == UPLight )  sf = ((1.15116+(0.00122657*pt))+(-3.63826e-06*(pt*pt)))+(2.08242e-09*(pt*(pt*pt)));
            else sf = ((1.06182+(0.000617034*pt))+(-1.5732e-06*(pt*pt)))+(3.02909e-10*(pt*(pt*pt)));
          } else if( fabs(eta) >= 0.8 && fabs(eta) < 1.6) {
            if( sys_ == DWLight )  sf = ((1.02055+(-0.000378856*pt))+(1.49029e-06*(pt*pt)))+(-1.74966e-09*(pt*(pt*pt)));
            else if( sys_ == UPLight )  sf = ((1.20146+(0.000359543*pt))+(-1.12866e-06*(pt*pt)))+(6.59918e-10*(pt*(pt*pt)));
            else sf = ((1.111+(-9.64191e-06*pt))+(1.80811e-07*(pt*pt)))+(-5.44868e-10*(pt*(pt*pt)));
          } else if( fabs(eta) >= 1.6 && fabs(eta) < 2.4) {
            if( sys_ == DWLight )  sf = ((0.983476+(-0.000607242*pt))+(3.17997e-06*(pt*pt)))+(-4.01242e-09*(pt*(pt*pt)));
            else if( sys_ == UPLight )  sf = ((1.18654+(-0.000795808*pt))+(3.69226e-06*(pt*pt)))+(-4.22347e-09*(pt*(pt*pt)));
          ...
          if( sys_ == DWLight )  sf = ((0.962627+(0.000448344*670.0))+(-1.25579e-06*(670.0*670.0)))+(4.82283e-10*(670.0*(670.0*670.0)));
          else if( sys_ == UPLight )  sf = ((1.12368+(0.00124806*670.0))+(-3.9032e-06*(670.0*670.0)))+(2.80083e-09*(670.0*(670.0*670.0)));
          else sf = ((1.04318+(0.000848162*670.0))+(-2.5795e-06*(670.0*670.0)))+(1.64156e-09*(670.0*(670.0*670.0)));
        } 
      } else if( algo_ == CSVT){
        if( pt <= 670 ){
          if( sys_ == DWLight )  sf = ((0.899715+(0.00102278*pt))+(-2.46335e-06*(pt*pt)))+(9.71143e-10*(pt*(pt*pt)));
          else if( sys_ == UPLight )  sf = ((0.997077+(0.00473953*pt))+(-1.34985e-05*(pt*pt)))+(1.0032e-08*(pt*(pt*pt)));
          else sf = ((0.948463+(0.00288102*pt))+(-7.98091e-06*(pt*pt)))+(5.50157e-09*(pt*(pt*pt)));
        }else { 
          if( sys_ == DWLight )  sf = ((0.899715+(0.00102278*670.0))+(-2.46335e-06*(670.0*670.0)))+(9.71143e-10*(670.0*(670.0*670.0)));
          else if( sys_ == UPLight )  sf = ((0.997077+(0.00473953*670.0))+(-1.34985e-05*(670.0*670.0)))+(1.0032e-08*(670.0*(670.0*670.0)));
          else sf = ((0.948463+(0.00288102*670.0))+(-7.98091e-06*(670.0*670.0)))+(5.50157e-09*(670.0*(670.0*670.0)));
        }
      }else { 
         sf = 1.0; 
      }
