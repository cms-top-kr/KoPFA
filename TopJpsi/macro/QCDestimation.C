void QCDestimation(){
  ...
  TFile *fQCD_ee = new TFile("TOPMASS_8TeV_QCD/ElEl2Mu/ElEl2Mu.root");
  TFile *fQCD_mm = new TFile("TOPMASS_8TeV_QCD/MuMu2Mu/MuMu2Mu.root");
  TFile *fQCD_em = new TFile("TOPMASS_8TeV_QCD/MuEl2Mu/MuEl2Mu.root");

  TFile *fQCD_iso_ee = new TFile("TOPMASS_8TeV_QCD_iso/ElEl2Mu/ElEl2Mu.root");
  TFile *fQCD_iso_mm = new TFile("TOPMASS_8TeV_QCD_iso/MuMu2Mu/MuMu2Mu.root");
  TFile *fQCD_iso_em = new TFile("TOPMASS_8TeV_QCD_iso/MuEl2Mu/MuEl2Mu.root");

  TFile *fQCD_noiso_ee = new TFile("TOPMASS_8TeV_QCD_noiso/ElEl2Mu/ElEl2Mu.root");
  TFile *fQCD_noiso_mm = new TFile("TOPMASS_8TeV_QCD_noiso/MuMu2Mu/MuMu2Mu.root");
  TFile *fQCD_noiso_em = new TFile("TOPMASS_8TeV_QCD_noiso/MuEl2Mu/MuEl2Mu.root");
