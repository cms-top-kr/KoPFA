#include "KoPFA/CommonTools/interface/FinalLeptonProducer.h"
...
FinalLeptonProducer::FinalLeptonProducer(const edm::ParameterSet& cfg)
{
...
FinalLeptonProducer::~FinalLeptonProducer()
{

}

void FinalLeptonProducer::produce(edm::Event& iEvent, const edm::EventSetup& es)
{
...
void 
FinalLeptonProducer::beginJob(){
}


void
FinalLeptonProducer::endJob() {
}


#include "FWCore/Framework/interface/MakerMacros.h"

DEFINE_FWK_MODULE(FinalLeptonProducer);
