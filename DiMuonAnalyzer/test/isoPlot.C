...
TString obj1 = "muon";
TString obj2 = "muon";
TString leg1 = obj1+" in PV = 1";
TString leg2 = obj2+" in PV > 1";

//TString dir = "Random400DataVsMuonWmunuWith0MeVForCH";
//TString dir = "pileupiso_NoPileupSequence";
  TString dir = "pileupiso";
//Chain * tree3 = new Chain("MuonIso/tree", "/tmp/tjkim/PFA/July5/Wmunu/isoNtuple_*.root");

void isoPlot(){
  TFile * nopileupdata = new TFile("/home/tjkim/ntuple/data/pileupstudy/RD_topref/vallot_nopileup.root");
  TFile * pileupfdata = new TFile("/home/tjkim/ntuple/data/pileupstudy/RD_topref/vallot_pileup.root");

  TChain * tree1 = (TChain *) nopileupdata->Get("MuonIso/tree");
  TChain * tree2 = (TChain *) pileupfdata->Get("MuonIso/tree");

  TChain * nopileuptree = (TChain *) nopileupdata->Get("MuonAna/tree");
  TChain * pileuptree = (TChain *) pileupfdata->Get("MuonAna/tree");
  ...
  plotSumpT(nopileuptree, pileuptree, "chIso", "chIso", hNameSumpT[0], titleSumpT[0], "Probability", Nbin, bins, cut1, cut2, "CH_default", p1, p2, printplot);
  plotSumpT(nopileuptree, pileuptree, "nhIso", "nhIso", hNameSumpT[1], titleSumpT[1], "Probability", Nbin, bins, cut1, cut2, "NH_default", p1, p2, printplot);
  plotSumpT(nopileuptree, pileuptree, "phIso", "phIso", hNameSumpT[2], titleSumpT[2], "Probability", Nbin, bins, cut1, cut2, "PH_default", p1, p2, printplot);
