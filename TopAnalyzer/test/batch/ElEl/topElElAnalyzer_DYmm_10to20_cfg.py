...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('vallot_DYmm_10to20.root')
)

process.load("PFAnalyses.TTbarDIL.Sources.ELE.MC.Fall10.patTuple_DYmm_10to20_cff")
process.source.fileNames = [
    'rfio:/castor/cern.ch/user/j/jhgoh/TopAnalysis/pf2pat/ElEl/MC/20110425/DYmm_10to20.root',
]
